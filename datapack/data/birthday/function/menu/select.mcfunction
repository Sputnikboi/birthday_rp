...
# RESCALE already-placed decorations nearby
execute if score @s bday.sel matches 102 at @s run function birthday:menu/scale_near
...
execute if score @s bday.sel matches 30 run tellraw @s {"text":"Party Hat selected. Click [PLACE] to spawn.","color":"green"}
# reset trigger
